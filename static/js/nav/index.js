...
function init_main_page() {
    ...
    // 添加侧边栏
    var html = `
    <li><a href="#systemViewer" class="nav-header" data-toggle="collapse" aria-expanded="true"><i
            class="glyphicon glyphicon-th-list"></i>hive统计<span class="pull-right glyphicon glyphicon-chevron-down"></span></a>
        <ul id="systemViewer" class="nav nav-list collapse secondmenu in" aria-expanded="true" style="height: 80px;">
