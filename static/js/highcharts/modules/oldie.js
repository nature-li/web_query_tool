...
(function(l) {
    ...
    (function(d) {
        ...
        var M = d.isArray,
            ...
            v = d.win,
            O = d.wrap;
        d.getOptions().global.VMLRadialGradientURL = "http://code.highcharts.com/6.0.7/gfx/vml-radial-gradient.png";
        h &&
        !h.defaultView && (d.getStyle = function(a, b) {
            var c = {
                width: "clientWidth",
                height: "clientHeight"
            }[b];
            if (a.style[b])
                return d.pInt(a.style[b]);
            "opacity" === b && (b = "filter");
            if (c)
                return a.style.zoom = 1, Math.max(a[c] - 2 * d.getStyle(a, "padding"), 0);
        ...
        Array.prototype.forEach || (d.forEachPolyfill = function(a, b) {
            for (var c = 0, e = this.length; c <
            e; c++)
                if (!1 === a.call(b, this[c], c, this))
                    return c
        });
        Array.prototype.indexOf || (d.indexOfPolyfill = function(a) {
            var b,
                c = 0;
            if (a)
        ...
        Array.prototype.filter || (d.filterPolyfill = function(a) {
            for (var b = [], c = 0, e = this.length; c < e; c++)
                a(this[c], c) && b.push(this[c]);
            return b
        });
        Object.prototype.keys || (d.keysPolyfill = function(a) {
            var b = [],
        ...
        Array.prototype.reduce || (d.reducePolyfill = function(a,
        b) {
            b = b || {};
            for (var c = this.length, e = 0; e < c; ++e)
                b = a.call(this, b, this[e], e, this);
            return b
        });
        D || (O(d.SVGRenderer.prototype, "text", function(a) {
            return a.apply(this, Array.prototype.slice.call(arguments, 1)).css({
                position: "absolute"
            })
        ...
        }, g.prototype.ieSanitizeSVG = function(a) {
            return a =
            a.replace(/<IMG /g, "\x3cimage ").replace(/<(\/?)TITLE>/g, "\x3c$1title\x3e").replace(/height=([^" ]+)/g, 'height\x3d"$1"').replace(/width=([^" ]+)/g, 'width\x3d"$1"').replace(/hc-svg-href="([^"]+)">/g, 'xlink:href\x3d"$1"/\x3e').replace(/ id=([^" >]+)/g, ' id\x3d"$1"').replace(/class=([^" >]+)/g, 'class\x3d"$1"').replace(/ transform /g, " ").replace(/:(path|rect)/g, "$1").replace(/style="([^"]+)"/g, function(a) {
                return a.toLowerCase()
            })
        }, g.prototype.isReadyToRender = function() {
            var a = this;
            return D || v != v.top ||
            "complete" === h.readyState ? !0 : (h.attachEvent("onreadystatechange", function() {
            ...
            var e = this;
            e.attachEvent && (e.hcEventsIE || (e.hcEventsIE = {}), b.hcKey || (b.hcKey = d.uniqueKey()), e.hcEventsIE[b.hcKey] = c, e.attachEvent("on" + a, c))
        }, d.removeEventListenerPolyfill =
        function(a, b) {
            ...
            init: function(a, b) {
                ...
                b && (c = d || "span" === b || "img" === b ? c.join("") : a.prepVML(c), this.element = A(c));
                this.renderer = a
            },
            add: function(a) {
                var b = this.renderer,
            ...
            getSpanCorrection: function(a, b, c, e, d) {
                ...
                this.yCorr = 0 > p && -q;
                h = 0 > f * p;
                this.xCorr += p * b * (h ? 1 - c : c);
                this.yCorr -= f * b * (e ? h ? c : 1 - c : 1);
                d && "left" !== d && (this.xCorr -= a * c * (0 > f ? -1 : 1), e && (this.yCorr -= q * c * (0 > p ? -1 : 1)), l(this.element, {
                    textAlign: d
                }))
            },
            pathToVML: function(a) {
                for (var b = a.length, c = []; b--;)
                    K(a[b]) ? c[b] = Math.round(10 *
                    a[b]) - 5 : "Z" === a[b] ? c[b] = "x" : (c[b] = a[b], !a.isArc || "wa" !== a[b] && "at" !== a[b] || (c[b + 5] === c[b + 7] && (c[b + 7] += a[b + 7] > a[b + 5] ? 1 : -1), c[b + 6] === c[b + 8] && (c[b + 8] += a[b + 8] > a[b + 6] ? 1 : -1)));
                return c.join(" ") || "x"
            },
            clip: function(a) {
                var b = this,
            ...
            shadow: function(a, b, c) {
                ...
                if (a) {
                    ...
                    for (d = 1; 3 >= d; d++)
                        J = 2 * l + 1 - 2 * d, c &&
                        (m = this.cutOffPath(r.value, J + .5)), k = ['\x3cshape isShadow\x3d"true" strokeweight\x3d"', J, '" filled\x3d"false" path\x3d"', m, '" coordsize\x3d"10 10" style\x3d"', f.style.cssText, '" /\x3e'], q = A(h.prepVML(k), null, {
                            left: t(g.left) + x(a.offsetX, 1),
                            top: t(g.top) + x(a.offsetY, 1)
                        }), c && (q.cutOff = J + 1), k = ['\x3cstroke color\x3d"', a.color || "#000000", '" opacity\x3d"', n * d, '"/\x3e'], A(h.prepVML(k), null, null, q), b ? b.element.appendChild(q) : f.parentNode.insertBefore(q, f), e.push(q);
                    this.shadows = e
                }
                return this
            },
            ...
            visibilitySetter: function(a, b, c) {
                "inherit" === a && (a = "visible");
                this.shadows && I(this.shadows, function(c) {
                    c.style[b] = a
                });
            ...
            color: function(a, b, c, e) {
                var p = this,
                    ...
                    g,
                    k = "none";
                a && a.linearGradient ? g = "gradient" : a && a.radialGradient && (g = "pattern");
                if (g) {
                    var r,
                        l,
                    ...
                    var y,
                        ...
                        C = function() {
                            ...
                            '" opacity\x3d"', u, '" o:opacity2\x3d"', t, '" type\x3d"', g, '" ', x, 'focus\x3d"100%" method\x3d"any" /\x3e'];
                    ...
                    1 > y[0] && a.push([1, y[1]]);
                    I(a, function(a, b) {
                        h.test(a[1]) ? (f = d.color(a[1]), r = f.get("rgb"), l = f.get("a")) : (r = a[1], l = 1);
                        B.push(100 * a[0] + "% " + r);
                        b ? (u = l, v = r) : (t = l, w = r)
                    });
                    if ("fill" === c)
                        if ("gradient" === g)
                            c = m.x1 || m[0] || 0, a = m.y1 || m[1] || 0, n = m.x2 || m[2] || 0, m = m.y2 || m[3] || 0, x = 'angle\x3d"' + (90 - 180 * Math.atan((m - a) / (n - c)) / Math.PI) + '"',
                            C();
                        else {
                            var k = m.r,
                                D = 2 * k,
                    ...
                    h.test(a) && "IMG" !== b.tagName ? (f = d.color(a), e[c + "-opacitySetter"](f.get("a"), c, b), k = f.get("rgb")) : (k = b.getElementsByTagName(c),
                    k.length && (k[0].opacity = 1, k[0].type = "solid"), k = a);
                return k
            },
            prepVML: function(a) {
                var b = this.isIE8;
            ...
            symbols: {
                arc: function(a, b, c, e, d) {
                    ...
                    if (0 === h - f)
                        return ["x"];
                    f = ["wa", a - g, b - g, a + g, b + g, a + g * e, b + g * p, a + g * k, b + g * l];
                    d.open && !c && f.push("e", "M", a, b);
                    f.push("at", a - c, b - c, a + c, b + c, a + c * k,
                    b + c * l, a + c * e, b + c * p, "x", "e");
                    f.isArc = !0;
                    return f
                },
                ...
                rect: function(a, b, c, d, g) {
                    return u.prototype.symbols[E(g) && g.r ? "callout" : "square"].call(0, a, b, c, d, g)
                }
            }
        }, d.VMLRenderer = w = function() {
            this.init.apply(this, arguments)
        }, w.prototype = N(u.prototype, g), d.Renderer = w);
        u.prototype.getSpanWidth = function(a, b) {
            var c = a.getBBox(!0).width;
            !D && this.forExport && (c = this.measureSpanWidth(b.firstChild.data,
            a.styles));
            return c
        };
