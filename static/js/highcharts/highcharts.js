                                ...
                                if (" " !== g) {
                                    ...
                                    if (O) {
                                        ...
                                        for (C && (F = w.applyEllipsis(a, k, g, O)); !C && r && (d.length || l.length);)
                                            a.rotation = 0, D = w.getSpanWidth(a, k), g = D > O, void 0 === F && (F = g),
            ...
            text: function(a, g, c, w) {
                ...
                w || (a.xSetter = function(a, g, c) {
                    ...
                    for (d = 0; d < w.length; d++)
                        b = w[d], b.getAttribute(g) === h && b.setAttribute(g,
                        a);
                    c.setAttribute(g, a)
                });
                return a
    ...
    (function(a) {
        ...
        a.Tick.prototype = {
            ...
            handleOverflow: function(a) {
                ...
                e) * p, c - e * p < d ? I = a.x + I * (1 - e) - d : b > m && (I = m - a.x + I * e, z = -1), I = Math.min(r, I), I < r && "center" === f.labelAlign && (a.x += z * (r - I - e * (r - Math.min(p, I)))), p > I || f.autoRotation && (h.styles || {}).width)
                    M = I;
            ...
            getSeriesExtremes: function() {
                ...
                function(g) {
                    if (g.visible || !b.options.chart.ignoreHiddenSeries) {
                        ...
                        w), !c.softThreshold || a.positiveValuesOnly)
                            a.softThreshold = !1
                    }
                })
            },
    ...
    (function(a, B) {
        ...
        a.extend(B.prototype,
        {
            ...
            removePlotBandOrLine: function(a) {
                for (var c = this.plotLinesAndBands, b = this.options, m = this.userOptions, d = c.length; d--;)
    ...
    (function(a) {
        ...
        a.Point.prototype = {
            ...
            destroyElements: function() {
                for (var a =
                    ["graphic", "dataLabel", "dataLabelUpper", "connector", "shadowGroup"], b, f = 6; f--;)
    ...
    (function(a) {
        ...
        u.prototype.setStackedPoints = function() {
            ...
            (!0 === this.visible || !1 === this.chart.options.chart.ignoreHiddenSeries)) {
                ...
                u.stacksTouched += 1;
                for (G = 0; G < d; G++)
                    g = c[G], w = b[G], x = this.getStackIndicator(x, g, this.index), J = x.key, A = (F = z && w < (e ? 0 : k)) ? t : n, D[A] || (D[A] = {}), D[A][g] || (C[A] && C[A][g] ? (D[A][g] = C[A][g], D[A][g].total =
    ...
    (function(a) {
        ...
        a.distribute = function(a, b) {
            ...
            for (a = t(a, function(a) {
                ...
                for (f = a.length; f--;)
                    h = a[f], m = (Math.min.apply(0, h.targets) + Math.max.apply(0, h.targets)) / 2, h.pos = Math.min(Math.max(0, m - h.size *
                    h.align), b - h.size);
                f = a.length;
                for (h = !1; f--;)
        ...
        b.prototype.drawDataLabels = function() {
            ...
            if (f.enabled || c._hasPointLabels)
                c.dlProcessOptions && c.dlProcessOptions(f), x = c.plotGroup("dataLabelsGroup", "data-labels", F && !v ? "hidden" : "visible", f.zIndex || 6), F && (x.attr({
                    opacity: +v
        ...
        b.prototype.alignDataLabel = function(a, b, c, d, l) {
            ...
            2) : "right" === r && (k.x -= n.width, k.y -= m ? 0 : n.height)) : (b.align(c, null, d), k = b.alignAttr), v ? a.isLabelJustified = this.justifyDataLabel(b, c, k, n, d, l) : u(c.crop, !0) && (t = e.isInsidePlot(k.x, k.y) && e.isInsidePlot(k.x + n.width, k.y + n.height)), c.shape && !q))
                b[l ? "attr" : "animate"]({
            ...
            c.visible && (l.enabled || c._hasPointLabels) && (q(d, function(a) {
                ...
                if (n)
                    ...
                    (h = Math.max(0, A - F - c.maxLabelDistance), k = Math.min(A + F + c.maxLabelDistance, f.plotHeight), q(b, function(a) {
                        ...
                        e = b[K], k = e.positionsIndex, g = e.labelPos, B = e.dataLabel, O = !1 === e.visible ? "hidden" : "inherit", N = h = g[1], p && E(p[k]) && (void 0 === p[k].pos ?
        ...
        function(a) {
            ...
            for (n = 0; n < f; n++)
                for (v = a[n], q = n + 1; q < f; ++q)
                    ...
                    0), c = k(c.x + m.translateX, c.y + m.translateY, v.width - h, v.height - h, b.x + d.translateX, b.y + d.translateY, u.width - h, u.height - h)))
        ...
        n(e.prototype, {
            ...
            setState: function(a) {
                ...
                (a && (f = e[a].lineWidth || f + (e[a].lineWidthPlus || 0)), d && !d.dashstyle))
                    for (f = {
                        "stroke-width": f
                    }, d.animate(f, h(e[a || "normal"] && e[a || "normal"].animation, b.chart.options.chart.animation)); b["zone-graph-" + c];)
